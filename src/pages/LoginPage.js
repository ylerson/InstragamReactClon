...
const img =
    'https://mott.marketing/wp-content/uploads/2017/11/Funciones-de-Instagram-1024x594.png';
...
export const LoginPage = () => {
    ...
    return (
        <div className="main_login">
                ...
                <div className="login_form">
                    ...
                    <GoogleLogin
                        ...
                        render={(renderProps) => (
                            ...
                            >
                                <FcGoogle className="logo_google" /> Sign in
                                With Google
                            </button>
                        )}
            ...
            <div className="footer_login">This page is an Instagram Clone.</div>
        </div>
    );
};
